        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TodoTagsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TodoItemTodoTag", x => new { x.TodoItemsId, x.TodoTagsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TodoItemTodoTag_TodoTags_TodoTagsId",
                        column: x => x.TodoTagsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TodoItemTodoTag_TodoTagsId",
